"""
Rails REST API 1 - Backend API
REST API with Ruby on Rails, Devise, PostgreSQL, and Sidekiq
"""
...
app = FastAPI(
    title="Rails REST API 1",
    description="REST API with Ruby on Rails, Devise, PostgreSQL, and Sidekiq",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "Rails REST API 1"}
